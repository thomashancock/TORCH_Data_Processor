...
bool isTimeReference(
	...
	const static std::set<uint> channelIDs { 31, 63, 159, 191, 287, 319, 415, 447, 543, 575, 671, 703, 799, 831, 927, 959 };
...
void Make2MCPHitmap(
	...
	// Setup Hitmap
	// ------------
	TH2D* hitmap = new TH2D("Hitmap","Hitmap",16,0.5,16.5,64,0.5,64.5);
