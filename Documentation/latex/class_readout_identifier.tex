...
\hyperlink{class_readout_identifier}{Readout\+Identifier} stores a combination of these pieces of information and allows comparison to check whether they are the same. 
